...
// BSplineDoc.cpp: CBSplineDoc 类的实现
//
...
CBSplineDoc::CBSplineDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CBSplineDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CBSplineDoc::InitializeSearchContent()
{
...
void CBSplineDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
